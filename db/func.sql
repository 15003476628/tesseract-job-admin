...
values (1, 'super_admin', '$2a$10$uVpmOfuXvWt7bKsD9VQJa.fSfuuLAt94a/e1WNlJ691aJ7rTWfni.', 1, 1562336661000,
        1562336661000,
        '默认调度组', 1);
insert into tesseract_trigger(name, next_trigger_time, prev_trigger_time, cron,
                              strategy, sharding_num, execute_param, retry_count,
                              status, creator, description, executor_id, executor_name,
                              create_time, update_time, group_name, group_id)
 values ('testTrigger-1', 1562512500000, 0, '*/15 * * * * ?', 0, 0,'', 0, 0 , 'super_admin',
  'test', 1, 'testExecutor'
 , 1562512500000, 1562512500000,'dev1',2);
